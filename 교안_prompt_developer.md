...
> **소요 시간**: 약 5~6시간
> **최종 검증**: 2026-07-04 · 모델명은 공식 문서로 확인. 2026년 6월 기준 최고 성능은 Claude Opus 4.8, Gemini는 3.1 Pro·3.5 Flash 세대입니다.
...
|------|----------------|----------|------|
| **Claude Opus 4.8** | 1M | 128K | 최고 성능, 복잡한 추론 |
| **Claude Sonnet 4.6** | 1M | 64K | 성능/비용 균형 |
| **Claude Haiku 4.5** | 200K | 64K | 빠른 응답, 저비용 |
| **GPT-4o** | 128K | 16K | 멀티모달, 빠른 응답 |
| **Gemini 3.1 Pro** | 2M | 65K | 초대형 컨텍스트 |
| **Gemini 3.5 Flash** | 1M | 64K | 빠른 최신 모델, 코딩·에이전트 |
