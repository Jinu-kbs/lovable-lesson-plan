...
**모든 색상은 지누켐 브랜드 톤을 따른다.** 기준값은 로고 원본(`JinuChem_Logo.svg`) 실측이며,
`common.css`의 `--jc-*` 토큰에 정의돼 있다.

| 토큰 | 값 | 역할 |
|------|-----|------|
| `--jc-blue` | `#006BB6` | 코어 딥블루 — 전역 크롬(홈·검색·비교) |
| `--jc-blue-d` | `#036EB7` | 분자 아이콘 |
| `--jc-sky` | `#2CA6E0` | 스카이 — 보조·그라디언트 |
| `--jc-ink` | `#333338` | 차콜 — 본문 텍스트 |

**톤 정렬 규칙(중요)**: 도구별 색상은 색조(hue)로만 구분하고, **흰 배경 대비를 전부 5.5:1로 고정**해
브랜드 블루 `#006BB6`과 동일한 시각적 무게를 갖는다. 새 도구 색을 추가할 때도 이 대비를 맞춘다.
맞추지 않으면 그 교안만 튀어 보이고 사이트가 한 벌로 읽히지 않는다.

| 도구 | Primary | Light | 교안 수준 |
|------|---------|-------|----------|
| **index.html** | `#006BB6` (지누켐 블루) | `#2CA6E0` | — |
| **Lovable** | `#0F7561` (초록) | `#1DB092` | 초보/중급/개발자 |
| **AntiGravity** | `#AE19C8` (마젠타) | `#D775E8` | 초보/중급/개발자 |
| **Cursor** | `#166BB1` (파랑) | `#53A2E3` | 초보/중급/개발자 |
| **AI Studio** | `#0F7913` (초록) | `#1EB523` | 초보/중급/개발자 |
| **Claude Code** | `#905E12` (오렌지) | `#D58D23` | 초보/중급/개발자 |
| **개발 인터페이스** | `#516C7A` (블루그레이) | `#87A0AC` | 초보/중급/개발자 |
| **ChatGPT/Codex** | `#0F775D` (그린) | `#1DB08C` | 초보/중급/개발자 |
| **프롬프트 엔지니어링** | `#CA1954` (핑크) | `#E9789D` | 초보/중급/개발자 |
| **Git/GitHub** | `#C92519` (레드) | `#E87D76` | 초보/중급/개발자 |
| **배포** | `#107380` (시안) | `#1FACBE` | 초보/중급/개발자 |
| **구글 생태계** | `#1A63D6` (구글블루) | `#6E9DE7` | 초보/중급/개발자 |
| **AI 교육 철학** | `#1867C2` (딥블루) | `#629FE5` | 단일 페이지 |
| **AI 과학교육** | `#0F7569` (다크틸) | `#1DAF9D` | 단일 페이지 |
| **NVIDIA GTC 2025** | `#4E730E` (NVIDIA 그린) | `#77AC1C` | 단일 페이지 (필독 리포트) |
| **하네스 엔지니어링** | `#5154E9` (인디고) | `#9294ED` | 단일 페이지 (심화 포스팅) |
| **클로드 스킬 가이드** | `#975913` (앰버) | `#DC8929` | 단일 페이지 (심화 가이드) |
| **소프트웨어 엔지니어링** | `#11728A` (사이안-틸) | `#21A9CC` | 단일 페이지 (심화 가이드) |
| **2026 트렌드 리포트** | `#CC1946` (크림슨) | `#E97995` | 단일 페이지 (리포트) |
| **MCP** | `#0E746C` (딥 틸) | `#1DAFA2` | 초급·중급·개발자 3단계 |
| **웹·앱 개발 기초** | `#7E41E7` (바이올렛) | `#AE8AEC` | 초보/중급/개발자 (SE 지식·실습 트랙) |
| **Claude Cowork** | `#A45214` (앰버브라운) | `#E08641` | 초보/중급/개발자 (Claude 생태계, 프리뷰) |
| **Claude Design** | `#B018C4` (푸크시아) | `#DA74E8` | 초보/중급/개발자 (Claude 생태계, 프리뷰) |
