...
| **웹·앱 개발 기초** | `#7C3AED` (바이올렛) | `#C4B5FD` | 초보/중급/개발자 (SE 지식·실습 트랙) |
| **Claude Cowork** | `#B45309` (앰버브라운) | `#FCD34D` | 초보/중급/개발자 (Claude 생태계, 프리뷰) |
| **Claude Design** | `#C026D3` (푸크시아) | `#F0ABFC` | 초보/중급/개발자 (Claude 생태계, 프리뷰) |
